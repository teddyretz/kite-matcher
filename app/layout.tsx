...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <title>FindMyKite — Find Your Next Kite</title>
        <meta name="description" content="Match your riding style to the right kite — with real reviews, not sponsored content." />
      </head>
